...
extension String {
    ...
    func padded(to width: Int, alignment: String = "left") -> String {
...
print("Testing Status Column Alignment")
print("================================\n")

print("String 1: '\(str1)'")
print("  Display Width: \(str1.displayWidth)")
print("  Unicode Scalars: ", terminator: "")
...
// Find the max width
let maxWidth = max(str1.displayWidth, str2.displayWidth)
print("Max Width: \(maxWidth)\n")

// Pad both to max width
let padded1 = str1.padded(to: maxWidth, alignment: "left")
let padded2 = str2.padded(to: maxWidth, alignment: "left")

print("Padded String 1: '\(padded1)' (width: \(padded1.displayWidth))")
print("Padded String 2: '\(padded2)' (width: \(padded2.displayWidth))")
